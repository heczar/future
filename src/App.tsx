...
function AppContent() {
    ...
    const unsubscribe = onSnapshot(docRef, (docSnap) => {
      if (docSnap.exists()) {
        ...
        const initialProfile: UserProfile = {
          ...
          philosophy: "Resultados y Estética.",
          projects: [],
  ...
  const spePhases = [
    ...
    { 
      ...
      longDesc: 'Transformamos la estrategia en píxeles y palabras. Aplicamos el criterio "Resultados y Estética" para que cada diseño cumpla una función comercial específica con la máxima calidad visual.',
      points: [
