  ...
  const plans = [
    {
      ...
      action: () => handleTogglePremium(false),
    ...
    },
    {
      ...
      cta: isPremiumActive ? "SUSCRIPCIÓN PRO ACTIVA" : "ACTIVAR POTENCIA GLOBAL ($10/mes)",
      action: () => handleTogglePremium(true),
      disabled: isPremiumActive,
      pro: true
    }
  ];
    ...
    <div className="max-w-7xl mx-auto space-y-16 py-12 px-4 sm:px-6">
      <div className="text-center space-y-4">
        ...
        <p className="text-slate-400 max-w-2xl mx-auto text-xs sm:text-sm">
          De una idea solitaria a una potencia empresarial. Selecciona el nivel de potencia que tu visión exige. En FUTURA PRO habilitamos el motor de notificaciones y la integración móvil nativa.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
        {plans.map((plan, i) => (
          ...
          >
            ...
            <p className="text-xs sm:text-sm text-slate-400 mb-10 leading-relaxed text-left">{plan.description}</p>
