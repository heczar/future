...
export default function FuturaHub({ 
  ...
  const [activeHubTab, setActiveHubTab] = useState<'consultation' | 'blueprint'>('consultation');
  ...
  return (
    <div className="space-y-8 max-w-[1240px] mx-auto pb-32 text-left">
      ...
      <div className="flex bg-black/40 p-1.5 rounded-2xl border border-white/5 max-w-xl">
        <button
          onClick={() => setActiveHubTab('consultation')}
          className={cn(
      ...
      {/* TAB CONTENT: CONSULTATION & DIAGNOSTICS */}
        ...
        {activeHubTab === 'consultation' ? (
          ...
          >
            ...
            <div className="lg:col-span-7">
              <div className="glass-panel border border-white/5 rounded-3xl bg-surface-950/40 p-6 space-y-4 flex flex-col h-[650px] justify-between">
                {/* Header chat info */}
          ...
          >
            {/* Left Column: Blueprint Builder configs */}
            <div className="lg:col-span-5 space-y-6">
              
              {/* Linked active brand status summary */}
            ...
            {/* Right Column: Interactive output viewer */}
            <div className="lg:col-span-7 space-y-6">
              
              {blueprintIsGenerating ? (
                <div className="p-12 bg-[#09090b] border border-white/5 rounded-3xl flex flex-col items-center justify-center text-center space-y-4 min-h-[500px]">
                ...
                <div className="glass-panel border border-white/5 rounded-3xl bg-surface-950/30 p-6 md:p-8 space-y-6 text-left">
                  ...
                  <div className="prose prose-invert prose-xs max-h-[450px] overflow-y-auto pr-1 text-slate-300 leading-relaxed text-xs border border-white/5 p-4 rounded-2xl bg-black/40">
                    <ReactMarkdown>
                  ...
                  {blueprintLogoUrl && (
                    <div className="bg-black/80 border border-white/5 rounded-2xl p-5 space-y-4">
                      ...
                      <div className="flex flex-col sm:flex-row items-center gap-4 text-left">
                        {/* Beautiful Logo framed preview wrapper */}
                        <div className="w-32 h-32 bg-[#080808] border border-white/10 rounded-2xl p-3 flex items-center justify-center shrink-0 shadow-inner group overflow-hidden relative">
                          <img 
                        ...
                        <div className="space-y-2 flex-1">
                          <p className="text-[10px] text-slate-400 leading-normal">
                            Este imagotipo minimalista se generó específicamente de acuerdo a las directivas de comunicación visual del Blueprint. La estética está alineada con tu cliente ideal de alto valor.
                          </p>
                          <div className="flex flex-wrap gap-2 pt-1">
                            <a 
                              ...
                              target="_blank"
                              rel="noreferrer"
                              className="px-2.5 py-1 bg-white/5 hover:bg-white/10 text-[8px] font-mono text-slate-300 rounded font-black border border-white/5 hover:border-white/10 transition-colors uppercase cursor-pointer"
                            >
                              Descargar PNG
                            </a>
                            ...
                            {activeBrand && (
                              <button
                                ...
                                className="px-2.5 py-1 bg-brand-primary hover:bg-brand-primary/80 disabled:opacity-40 text-[8px] text-white font-black rounded tracking-wider uppercase transition-all cursor-pointer"
                              >
                          ...
                          {blueprintLogoSaveStatus === 'success' && (
                            <p className="text-[8px] text-emerald-400 font-bold uppercase tracking-wider">
                              ✓ Isotipo añadido satisfactoriamente al portafolio de activos de la marca
                            </p>
                          )}
                        </div>
                      </div>
                ...
                <div className="border border-dashed border-white/5 rounded-3xl p-12 text-center flex flex-col items-center justify-center min-h-[500px] text-slate-600 space-y-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-[9px] text-slate-500 max-w-sm leading-normal">
                      Configura la descripción de tu marca a la izquierda y presiona en "Sintetizar Blueprint SPE" para generar misiones, avatares, pitches, taglines de campaña y logotipos AI vectoriales de alta fidelidad.
                    </p>
                  </div>
                </div>
              )}
